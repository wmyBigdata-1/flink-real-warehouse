...
import com.wmy.flink.warehourse.bean.KeywordStats;
import com.wmy.flink.warehourse.common.WmyConstant;
import com.wmy.flink.warehourse.func.KeyWordUDTF;
...
public class KeyWordStatsApp {
    public static void main(String[] args) throws Exception {
        ...
        Table resultTable = tableEnv.sqlQuery("select keyword," +
                "count(*) ct, '"
                + WmyConstant.KEYWORD_SEARCH + "' source ," +
